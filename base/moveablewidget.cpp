...
//MOVEPLAN MoveableWidget::move_plan() const
//{
//    return move_plan_;
//}
...
//bool MoveableWidget::winEvent(MSG *message, long *result)
//{
//    if(move_plan_ == PLANB){
...
//void MoveableWidget::region(const QPoint &cursorGlobalPoint)
//{
//    QRect rect = this->rect();
//    QPoint tl = mapToGlobal(rect.topLeft());
//    QPoint rb = mapToGlobal(rect.bottomRight());
...
//void MoveableWidget::setMove_plan(const MOVEPLAN &move_plan)
//{
//    move_plan_ = move_plan;
//}

//bool MoveableWidget::isDragAble() const
//{
//    return isDragAble_;
//}

//void MoveableWidget::setIsDragAble(bool isDragAble)
//{
